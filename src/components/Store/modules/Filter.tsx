      ...
      <div className="relative w-full h-fit gap-6 flex flex-col bg- px-3 pb-3 pt-7 text-white">
          ...
          <div className="relative grid grid-cols-2 gap-1.5 items-center justify-start w-full h-fit">
            {[
              ...
              return (
                <div
                  key={index}
                  className={`relative w-full h-28 rounded-sm flex text-xxs cursor-pointer border-viol ${
        ...
        <div className="relative flex flex-col gap-2 justify-start items-start w-full">
          ...
          {mentionProfiles?.length > 0 && profilesOpen?.[0] && (
            <div
              className={`absolute w-72 border border-viol max-h-28 h-fit flex flex-col overflow-y-auto items-start justify-start z-40 top-14 left-0 rounded-sm`}
            >
                ...
                return (
                  <div
                    ...
                    onClick={() => {
                      ...
                      setSearchFilters({
                        ...searchFilters,
                        designer: user?.handle?.suggestedFormatted?.localName!,
        ...
        <div className="relative flex flex-col gap-2 justify-start items-start pb-4">
          ...
          <div className="relative flex flex-row gap-1.5 items-center justify-start text-super font-dog">
