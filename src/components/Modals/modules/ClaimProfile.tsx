          ...
          <div className="relative w-full h-fit items-center justify-center flex flex-col gap-3 pb-4">
            ...
            >
              <Image
                ...
                layout="fill"
                src={`${INFURA_GATEWAY}/ipfs/QmYWFhNPVoJ4DHjddco7bz3NfegGYfSHPKz9y7kUQDSyBV`}
                draggable={false}
                objectFit="cover"
              />
            </div>
            <div
              ...
              className="relative border border-viol w-32 h-8 cursor-pointer flex items-center justify-center active:scale-95 py-1 rounded-sm text-xs font-vcr text-white"
            >
