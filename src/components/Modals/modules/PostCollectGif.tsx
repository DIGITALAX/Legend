...
const PostCollectGif: FunctionComponent<PostCollectGifProps> = ({
  ...
  return (
    <div className="inset-0 justify-center fixed z-50 bg-opacity-50 backdrop-blur-sm overflow-y-hidden grid grid-flow-col auto-cols-auto w-full h-auto">
      <div className="relative w-[90vw] md:w-[50vw] h-fit max-h-[90vh] min-h-[27vh] place-self-center bg-mar/75 rounded-sm border border-lima overflow-y-scroll">
        <div className="relative w-full h-full flex flex-col gap-3 p-2 items-center justify-start">
          ...
          {type === "gif" ? (
            ...
            >
              <div className="relative w-full h-fit flex flex-row items-center font-dog text-black justify-between text-super rounded-md gap-2">
                <input
                  className="relative w-full h-10 py-px px-1 border border-black rounded-md bg-lima"
                ...
                />
                <div
                  className={`w-16 px-2 py-1 border rounded-md text-super border-black text-black bg-lima h-10 border flex items-center justify-center ${
                  ...
                  {openMeasure.searchedGifs?.map((gif: any, index: number) => {
                    return (
                      <div
                        ...
                        className="relative w-20 h-20 rounded-md flex items-center justify-center cursor-pointer hover:opacity-70 bg-mar"
                      >
                        <Image
                          layout="fill"
                          objectFit="cover"
